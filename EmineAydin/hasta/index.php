...
$sql = "SELECT * FROM Hasta ORDER BY HastaID DESC";
...
<head>
    ...
    <title>Hasta Yönetimi - Hastane Otomasyon Sistemi</title>
...
<body>
    ...
    <main>
        ...
        <div class="actions">
            <a href="ekle.php" class="button">Yeni Hasta Ekle</a>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo htmlspecialchars($row['HastaID']); ?></td>
                    <td><?php echo htmlspecialchars($row['Ad']); ?></td>
                    <td><?php echo htmlspecialchars($row['Soyad']); ?></td>
                    <td><?php echo htmlspecialchars($row['TelefonNumarasi']); ?></td>
                    <td><?php echo htmlspecialchars($row['EPosta']); ?></td>
                    <td><?php echo htmlspecialchars($row['DogumTarihi']); ?></td>
                    <td><?php echo htmlspecialchars($row['Cinsiyet']); ?></td>
                    <td>
                        <a href="duzenle.php?id=<?php echo $row['HastaID']; ?>" class="button">Düzenle</a>
                        <a href="sil.php?id=<?php echo $row['HastaID']; ?>" class="button" onclick="return confirm('Bu hastayı silmek istediğinizden emin misiniz?')">Sil</a>
                    </td>
                </tr>
                <?php endwhile; ?>
            </tbody>
