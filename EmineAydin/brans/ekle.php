...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Aynı isimde branş var mı kontrol et
    $checkSql = "SELECT COUNT(*) as count FROM Brans WHERE BransAdi = '$bransAdi'";
    ...
    // Yeni branşı ekle
    $sql = "INSERT INTO Brans (BransAdi) VALUES ('$bransAdi')";
...
<head>
    ...
    <title>Yeni Branş Ekle - Aydın Hastanesi</title>
...
<body>
    ...
    <main>
        <h1>Yeni Branş Ekle</h1>
        
        <form method="POST" class="form">
            <div class="form-group">
                <label for="bransAdi">Branş Adı:</label>
                <input type="text" id="bransAdi" name="bransAdi" required>
            </div>
            
            <div class="form-actions">
                <button type="submit" class="button">Branş Ekle</button>
